...
class ResponsesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create response" do
    assert_difference('Response.count') do
      post responses_url, params: { response: { answers: @response.answers, session: @response.session, view: @response.view } }
    end
  ...
  test "should update response" do
    patch response_url(@response), params: { response: { answers: @response.answers, session: @response.session, view: @response.view } }
